...
CKPT="${CKPT:-${REPO_ROOT}/results/Checkpoints/piper_pick_white_block_20260818_qwenpi_measured_50hz_h50/checkpoints/steps_10000_pytorch_model.pt}"
PORT="${PORT:-10093}"
GPU_ID="${GPU_ID:-0}"
...
exec "${STARVLA_PYTHON}" \
  examples/realRobots/Piper/eval_files/piper_qwenpi_v3_rtc_server.py \
  --ckpt_path "${CKPT}" \
  --port "${PORT}" \
