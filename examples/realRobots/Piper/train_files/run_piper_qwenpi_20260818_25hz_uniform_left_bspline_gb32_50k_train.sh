...
CONFIG_YAML="${CONFIG_YAML:-${REPO_ROOT}/examples/realRobots/Piper/train_files/starvla_qwenpi_piper_20260818_25hz_uniform_left_bspline_gb32_50k.yaml}"
...
RUN_ID="${RUN_ID:-piper_pick_white_block_20260818_qwenpi_25hz_uniform_left_bspline_s2_h20_c13_gb32_50k}"
